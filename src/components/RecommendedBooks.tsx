    ...
    <div>
        <div className="flex items-center justify-center mt-20">
            ...
            <div className="w-[600px]">
                <h2 id="book-title" className="text-white text-3xl mt-5 p-1">{books[currentImageIndex].book.title}</h2>
                <p id="book-author" className="text-white mt-2 p-1">{books[currentImageIndex].book.author}</p>
                ...
                <div className="relative justify-center items-center">
                    ...
                    <div className="bg-[#3E3647] absolute bottom-1 right-5 items-center flex p-2 rounded-md cursor-pointer" onClick={goToBookPage}>
                        <p id="book-price" className="price text-white text-[20px] m-2">
                        {books[currentImageIndex].book.price}
                        </p>
                    </div>
                    ) : (
                    <div className="bg-[#3E3647] absolute bottom-1 right-5 flex items-center p-2 rounded-md cursor-pointer" onClick={goToBookPage}>
